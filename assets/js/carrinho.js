...
(() => {
  ...
  const calculateFreight = () => {
    ...
    window.MarDeHistorias?.showToast?.({
      ...
      message: 'A estimativa de entrega foi atualizada no resumo.',
  ...
  const initCartActions = () => {
    ...
    checkoutButton?.addEventListener('click', () => {
      ...
      window.MarDeHistorias?.showToast?.({
        ...
        message: 'Tudo pronto. A próxima etapa será o checkout de endereço e pagamento.',
